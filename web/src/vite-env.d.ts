...
interface ImportMetaEnv {
    ...
    readonly VITE_LOGTO_SCOPE?: string;
    readonly VITE_NEW_API_BASE_URL?: string;
    readonly VITE_NEW_API_PUBLIC_URL?: string;
    readonly VITE_NEW_API_DISPLAY_NAME?: string;
    readonly VITE_NEW_API_LOGTO_AUDIENCE?: string;
    readonly VITE_NEW_API_LOGTO_SCOPE?: string;
